...
let learn = titleCase("i am learning typescript");
console.log(learn);
...
const magicians_array = ["Asim", "Qasim", "Zahoor"];
...
let greatMagicians = make_great(magicians_array);
